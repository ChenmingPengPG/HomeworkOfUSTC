...
public class Conversation {
     ...
     */
    public static BaseBean getObject(BaseBean user) throws ParserConfigurationException, SAXException,
     ...
     * @throws SQLException
     */
    public static ResultSet query(BaseBean user) throws ParserConfigurationException,
     ...
     * @throws SQLException
     */
    public static boolean insert(BaseBean user) throws ParserConfigurationException, SAXException,
     ...
     * @throws ClassNotFoundException
     */
    public static boolean update(BaseBean user) throws ParserConfigurationException, SAXException,
            IOException, SQLException, ClassNotFoundException {
     ...
     * @throws ClassNotFoundException
     */
    public static boolean deleteObject(BaseBean user) throws ParserConfigurationException, SAXException,
            IOException, SQLException, ClassNotFoundException {
